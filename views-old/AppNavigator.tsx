...
export default class AppNavigator extends ComponentBase<AppNavigatorProps & { history: any }, WebAppRouterState> {
  ...
  public render() {
    const TabBarElement = this._renderTabBar(this.props.me)
        ...
        {({ theme }) => (
          <Router history={this.props.history}>
            ...
            >
              ...
              {TabBarElement}
              {this._renderDrawer(theme, this.props.me)}
  ...
  private _renderDrawer = (theme: Theme, me: Me | null) => {
    if (this.state.hideDrawer && !me) return null
  ...
  */
  ...
  private _renderTabBar = (me: Me | null) => {
    ...
    if (me && (me.username === trimSlashes(currentPath))) {
