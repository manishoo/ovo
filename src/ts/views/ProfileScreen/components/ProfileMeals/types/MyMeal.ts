...
export interface MyMeal_items_food_imageUrl {
  url: string;
}

export interface MyMeal_items_food_thumbnailUrl {
  url: string;
}
...
export interface MyMeal_items_food {
  ...
  imageUrl: MyMeal_items_food_imageUrl;
  thumbnailUrl: MyMeal_items_food_thumbnailUrl;
}
...
export interface MyMeal_items_recipe_coverImage {
  url: string;
}
...
export interface MyMeal_items_recipe_author_imageUrl {
  url: string;
}
...
export interface MyMeal_items_recipe_author {
  id: string;
  username: string;
  imageUrl: MyMeal_items_recipe_author_imageUrl | null;
}
...
export interface MyMeal_items_recipe {
  ...
  coverImage: MyMeal_items_recipe_coverImage | null;
...
export interface MyMeal_items_alternativeMealItems_food_imageUrl {
  url: string;
}

export interface MyMeal_items_alternativeMealItems_food_thumbnailUrl {
  url: string;
}
...
export interface MyMeal_items_alternativeMealItems_food {
  ...
  imageUrl: MyMeal_items_alternativeMealItems_food_imageUrl;
  thumbnailUrl: MyMeal_items_alternativeMealItems_food_thumbnailUrl;
}
...
export interface MyMeal_items_alternativeMealItems_recipe_coverImage {
  url: string;
}
...
export interface MyMeal_items_alternativeMealItems_recipe_author_imageUrl {
  url: string;
}
...
export interface MyMeal_items_alternativeMealItems_recipe_author {
  id: string;
  username: string;
  imageUrl: MyMeal_items_alternativeMealItems_recipe_author_imageUrl | null;
}
...
export interface MyMeal_items_alternativeMealItems_recipe {
  ...
  coverImage: MyMeal_items_alternativeMealItems_recipe_coverImage | null;
...
export interface MyMeal_author_imageUrl {
  url: string;
}
...
export interface MyMeal_author {
  id: string;
  username: string;
  imageUrl: MyMeal_author_imageUrl | null;
}
