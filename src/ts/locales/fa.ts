export default {
  ...
  'terms': 'By creating a new account or signing in, You are agreeing to Caloria’s Terms of Service and Privacy Policy.',
  ...
  'landing_1_s': 'کالریا درمورد شرایط بدنیتون، طبع و سلیقه\u200Cتون، بیماریاتون، بودجه و هدف تندرستیتون باهاتون صحبت می\u200Cکنه، وقتی خوب شناختتون به کمک متخصصین تغذیه برنامه غذایی اختصاصیتون رو پیگیری می\u200Cکنه.',

  'landing_2_t': 'خیالتون راحت، اصلا بهش فکر نکنین',
  'landing_2_s': 'هروقت وقت غذاست کالریا پر سر و صداست.\nاطلاع رسانی\u200Cها، ذخیره\u200Cسازی فعالیت\u200Cهای بدنی و پیگیری سلامتی شما بخشی از وظایف کالریاست.',
  ...
  'landingfooterAck': 'استفاده از مطالب کالریا فقط برای مقاصد غیرتجاری و با ذکر منبع بلامانع است. کلیه حقوق این سایت متعلق به  mycaloria.com می\u200Cباشد.',
  ...
  'LandingFooterAboutCaloria': 'درباره کالریا',
  'LandingFooterContactUs': 'ارتباط با ما',
  'LandingFooterTerms': 'مقررات استفاده',
  'LandingFooterSocialMediaText': 'کالریا را در شبکه های اجتماعی دنبال کنید',
  ...
  'hiAssistant': 'سلام کالریا \uD83D\uDC4B',
  'AssistantInputPlaceholder': 'پیام',
  'getNamePlaceholder': 'مثلا محمد',
  'getAgePlaceholder': 'مثلا ۳۲',

  'cancel': 'بازگشت',
  'editMealSettings': 'تنظیمات وعده‌ غذایی',
  'viewAlternatives': 'مشاهده دیگر گزینه‌ها',
  'recurOn': 'تکرار در ...',
  'mealItemExample': 'مثلا موز، برنج، زردچوبه، ...',
  ...
  'e.g. Cook the Rice...': 'مثلا برنج را بپزید...',
  'Delete Recipe': 'حذف',
